...
public class Editlead 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("TestleadFN");
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("TestleadLN");
		...
		driver.findElement(By.id("updateLeadForm_importantNote")).sendKeys("sample info for imp note control");
